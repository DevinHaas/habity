  ...
  return (
    ...
    >
      ...
      <div className="relative bg-card/95 backdrop-blur-sm rounded-3xl shadow-2xl overflow-hidden border-2 border-orange/20">
        ...
        <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-olive via-olive-light to-olive" />
        
        {/* Corner decorations */}
        <div className="absolute top-4 left-4 w-8 h-8 border-l-2 border-t-2 border-olive/30 rounded-tl-lg" />
        <div className="absolute top-4 right-4 w-8 h-8 border-r-2 border-t-2 border-olive/30 rounded-tr-lg" />
        <div className="absolute bottom-4 left-4 w-8 h-8 border-l-2 border-b-2 border-olive/30 rounded-bl-lg" />
        <div className="absolute bottom-4 right-4 w-8 h-8 border-r-2 border-b-2 border-olive/30 rounded-br-lg" />
          ...
          <form onSubmit={handleEmailSignup} className="space-y-4">
            <div className="space-y-2">
              ...
              <div className="relative">
                <User className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-brown-light" />
                <Input
                  id="name"
                  type="text"
                  ...
                  className="pl-10 bg-cream-dark/50 border-cream-dark focus:border-olive focus:ring-olive/20 text-brown placeholder:text-brown-light/50 rounded-xl"
                  required
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <Input
                  ...
                  className="pl-10 pr-10 bg-cream-dark/50 border-cream-dark focus:border-olive focus:ring-olive/20 text-brown placeholder:text-brown-light/50 rounded-xl"
                  required
                  minLength={8}
                />
                <button
            ...
            <Button
              type="submit"
              disabled={isLoading}
              className="w-full bg-olive hover:bg-olive/90 text-white font-semibold rounded-xl h-12 shadow-lg shadow-olive/25 transition-all hover:shadow-olive/40 hover:scale-[1.02] active:scale-[0.98]"
            >
              {isLoading ? (
